  ...
  svg(
    ...
    g#layer(data-name='layer')
      g#shobon
        ...
        g#hand(@click="animateHand")
          path(
            stroke='black',
            fill='white',
            stroke-width='7px',
            stroke-linecap='round',
            stroke-linejoin='round', d='M399.5,277.5a66.4,66.4,0,0,0,10,18c9.23,11.68,22.54,22.56,30.95,24.28,8.05,2.72,22.53,4.93,31-2,6.45-5.31,9.67-13.76,10.39-22.08s-.78-16.66-2.31-24.87'
            )
            animate#handAnimate(
              begin='indefinite'
              dur='.2s',
              repeatCount='5',
              attributeName='d',
              attributeType='XML', from='M399.5,277.5a66.4,66.4,0,0,0,10,18c9.23,11.68,22.54,22.56,30.95,24.28,8.05,2.72,22.53,4.93,31-2,6.45-5.31,9.67-13.76,10.39-22.08s-.78-16.66-2.31-24.87',
...
export default {
  ...
  mounted: function() {
    this.hand = document.getElementById("handAnimate");
    this.body = document.getElementById("shobon");
  },
  methods: {
